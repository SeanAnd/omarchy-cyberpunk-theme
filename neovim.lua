return {
	{
		...
		opts = {
			colorscheme = function()
				...
				hl(0, "@keyword.coroutine", { fg = colors.red })
				hl(0, "@keyword.function", { fg = colors.red })
				hl(0, "@keyword.operator", { fg = colors.red })
				hl(0, "@keyword.import", { fg = colors.yellow })
				hl(0, "@keyword.conditional", { fg = colors.red })
				hl(0, "@keyword.repeat", { fg = colors.red })
				hl(0, "@keyword.return", { fg = colors.red })
				hl(0, "@keyword.exception", { fg = colors.bright_purple })
				hl(0, "@comment", { fg = colors.bright_black, italic = true })
